...
const uint8_t FONTE_DATA[] = {
    0x04, 0x06, 0x30, 0x0A,  // Largura: 4px, Altura: 6px, Início: '0' (0x30), Qtd: 10 caracteres
    // Dígitos 0-9
    ...
    // Caracteres adicionais para data/hora
    0x00, 0x36, 0x36, 0x00,  // ':'
    0x04, 0x0A, 0x0A, 0x04,  // '/'
...
const uint8_t FONT_1[] = {
    0x06, 0x08, 0x20, 0x5F,               // x_size, y_size, offset, number of char 0x06 0x08
