...
# 185 "./servo.h"
void __attribute__((picinterrupt(("low_priority")))) High_ISR(void)
{
...
void __attribute__((picinterrupt(("high_priority")))) Low_ISR(void) {
    if (PIR1bits.TMR1IF) {
...
void main()
{
    ...
    DS3231_Set_Date_Time(10,2,25,2,13,30,0);
    ...
    while(1)
    {
        ...
        _delay((unsigned long)((1200)*(48000000/4000.0)));
    }
}
